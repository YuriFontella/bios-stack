...
export default function Example() {
  ...
  return (
    <Dialog
      as="div"
      static
      className="fixed z-10 inset-x-0 overflow-y-auto bg-gray-100"
      initialFocus={true}
      open={open}
      onClose={setOpen}
    >
      <div className="flex items-center justify-center min-h-screen text-center sm:block sm:pt-40 md:pt-40 px-4 sm:px-0">
